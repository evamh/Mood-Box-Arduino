# Mood Box using an Arduino
Final Project for *Creative Making: Physical Computing* in my MSc Creative Computing course. 
...
Future avenues for this project could include:
